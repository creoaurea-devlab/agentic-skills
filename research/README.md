...
This section contains the raw knowledge base that informed the [skills](../skills/) in this repo. Think of it as the "show your work" section — the research behind the recipes.

## Contents

| Document | What's Inside |
|----------|--------------|
| [**TypeScript 2026 Stack**](typescript-2026-stack.md) | The perfect TypeScript stack for plugin-based apps — library choices with bundle sizes, code patterns, and configuration for every layer from a 381-byte event bus to mutation testing |
...
The research was then distilled into actionable [skills](../skills/) that AI agents can use directly.
